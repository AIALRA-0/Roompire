          ...
          <div className="px-4 py-6 sm:px-6 lg:px-8">
            ...
            <CalendarWorkspace
              ...
              labels={{
                ...
                deleteEventConfirm: calendar("deleteEventConfirm"),
                editTask: calendar("editTask"),
                saveTask: calendar("saveTask"),
                deleteTask: calendar("deleteTask"),
                deleteTaskConfirm: calendar("deleteTaskConfirm"),
                cancelEdit: calendar("cancelEdit"),
                eventCreated: calendar("eventCreated"),
                eventUpdated: calendar("eventUpdated"),
                eventDeleted: calendar("eventDeleted"),
                taskCreated: calendar("taskCreated"),
                taskUpdated: calendar("taskUpdated"),
                taskDeleted: calendar("taskDeleted"),
                ...
                autoProposalTemplate: calendar("autoProposalTemplate"),
                autoProposalTemplateConfigured: calendar("autoProposalTemplateConfigured"),
                autoProposalTitle: calendar("autoProposalTitle"),
