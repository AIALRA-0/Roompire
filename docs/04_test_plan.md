...
5. Filter the calendar/task workspace by type, member, category, status, and priority.
6. Assigned member completes task.
7. API confirms linked task/event records and completed statuses.
