...
2. Continue root-disk capacity planning; production now has roughly 4.4GiB free after post-deploy build-cache cleanup, and ops health intentionally warns with disk pressure.
