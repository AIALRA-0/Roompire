...
3. Continue root-disk capacity planning; production build/test runs can still push root usage above 99%, and the latest calendar work filters deploy ended around 5.8GB free / 98% used after removing regenerated checkout artifacts, old browser-workspace generated artifacts, and Docker build cache.
