...
2. Continue root-disk capacity planning; production now has roughly 8.8GB free after post-deploy build-cache cleanup, and ops health intentionally warns about high Docker reclaimable storage.
