...
3. Continue root-disk capacity planning; disk-capacity trend visibility is live, but the current server still ends deployments around 8.7GB free / 96% used and needs longer history plus a larger disk or broader image-retention policy before high-usage warnings clear.
