...
2. Continue root-disk capacity planning; production now has roughly 6.7GiB free after post-deploy build-cache cleanup, and ops health intentionally warns with disk pressure plus high Docker reclaimable storage.
