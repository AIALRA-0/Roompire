...
3. Continue root-disk capacity planning; production build/test runs can still push root usage above 99%, and the latest task board views deploy ended around 6.5GB free / 97% used after removing regenerated checkout artifacts, old browser-workspace generated artifacts, and Docker build cache.
