...
2. Continue root-disk capacity planning; production now has roughly 8.0GB free after post-deploy build-cache cleanup, and ops health intentionally warns when disk or Docker reclaimable storage crosses configured thresholds.
