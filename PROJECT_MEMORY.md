...
- Expense proposal filter indexes slice implemented on branch `db/proposal-filter-indexes`: migration `20260706010000_add_expense_proposal_filter_indexes` adds queue-order, status/category/date/amount, tag, payer, and share participant indexes for the dashboard proposal filter and cursor-pagination read paths.
...
- 2026-07-06 Expense proposal filter indexes:
  - Branch: `db/proposal-filter-indexes`.
