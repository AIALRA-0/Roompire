...
3. Continue root-disk capacity planning; production build/test runs can still push root usage above 99%, and the latest expense proposal filters deploy ended around 3.3GB free / 99% used after removing regenerated checkout artifacts before the Docker build.
