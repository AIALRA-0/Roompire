...
- 2026-07-04 Household exports:
  ...
  - Live-domain rollout remains blocked: HTTP `roompire.aialra.online` returns nginx 500, normal HTTPS fails hostname certificate validation, HTTPS only returns content with certificate verification disabled, and this environment has no SSH private key for the VPS.
- 2026-07-04 Household statistics:
  ...
  - Live-domain probe still blocks direct rollout: HTTP `roompire.aialra.online` returns nginx 500, normal HTTPS fails hostname certificate validation, HTTPS only returns content with certificate verification disabled, and this environment has no SSH private key for the VPS.
